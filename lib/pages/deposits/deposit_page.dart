      ...
      body: ListView(
        children: [
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.asset('images/contact_Depositor.png',height: 35,),
                            SizedBox(height: 5,),
                            Text('Contact Depositor',style: TextStyle(fontSize: 14,color: Color(0xff043655)),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Image.asset('images/make_deposit.png',height: 35,),
                            SizedBox(height: 5,),
                            Text('Make a Deposit',style: TextStyle(fontSize: 14,color: Color(0xff043655)),),
          ...
          Container(
            ...
            child: Text('Deposit history',style: TextStyle(fontWeight: FontWeight.bold),),
          ),
          ...
          children: [
            Padding(
              ...
              child: Column(
                ...
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text('Contact Depositor',style: TextStyle(color: Colors.blue,fontSize: 16,fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    height: 1,
                  ...
                  SizedBox(height: 10,),
                  Text('Join Telegram',style: TextStyle(color: Colors.blue,fontSize: 13,fontWeight: FontWeight.bold),)
